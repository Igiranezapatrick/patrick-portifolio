...
export function SiteNav() {
  return (
    <header className="relative z-30 flex justify-center px-4 pt-7 sm:px-6 lg:px-8">
      <nav className="flex items-center gap-2 rounded-2xl bg-[#272829] border border-white/10 px-4 py-3 sm:px-5">
        {iconLinks.map((link, index) => (
          <a
            ...
            className={`group flex h-11 w-11 items-center justify-center rounded-xl transition-all ${
              index === 0
                ? "bg-gradient-to-br from-[#914bf1] to-[#ad63ff] text-white"
